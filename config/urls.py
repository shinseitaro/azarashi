...
from user.views import GithubLoginView, TwitterLoginView, FetchTokenView, UserJWTDetailView
...
urlpatterns = [
    ...
    path('api/user/jwt/', UserJWTDetailView.as_view(), name="current_user_jwt"),
